		...
		<div class="container">
			...
			<div class='card'>
				...
				<c:set var="bigliettoInPagina"
					value="${requestScope.BigliettoToDelete}" />

				<div class='card-body'>
					<dl class="row">
						<dt class="col-sm-3 text-right">Provenienza</dt>
						<dd class="col-sm-9">
							<c:out value="${bigliettoInPagina.provenienza}" />
						</dd>
					</dl>
					...
					<dl class="row">
						...
						<dd class="col-sm-9">
							<c:out value="${bigliettoInPagina.destinazione}" />
						</dd>
					</dl>
					...
					<dl class="row">
						...
						<dd class="col-sm-9">
							<c:out value="${bigliettoInPagina.prezzo}" />
						</dd>
					</dl>
					...
					<dl class="row">
						...
						<dd class="col-sm-9">
							<c:out
								value="${bigliettoInPagina.data.format(DateTimeFormatter.ofPattern('dd/MM/yyyy'))}" />
						</dd>
					</dl>
				...
				<div class='card-footer'>
					...
					<form action="ExecuteDeleteBigliettoServlet" method="post">
						<input type="hidden" name="idDelete"
							value="<c:out value="${bigliettoInPagina.id}" />"> <input
