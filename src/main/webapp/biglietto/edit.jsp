			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteUpdateBigliettoServlet" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									<label for="destinazione" class="form-label">Descrizione <span class="text-danger">*</span></label>
				     ...
				     <a href="http://localhost:8080/gestionebigliettiweb/index.jsp" target="_self"> Torna a index</a>
